...
if __name__ == "__main__":
    ...
    print("Setting current storage limit of CrashDump to above storage limit threshold.")
    request_body = {
    ...
    # set current storage useage over the storage limit
    print("Setting current storage limit of BuildSytem to above storage limit threshold.")
    request_body = {
